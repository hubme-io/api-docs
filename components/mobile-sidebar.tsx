...
export function MobileSidebar({
  ...
  useEffect(() => {
    onClose()
  }, [selectedSection, selectedEndpoint, onClose])
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div className="fixed inset-y-0 left-0 w-80 max-w-[85vw] bg-white z-50 lg:hidden flex flex-col">
        {/* Header */}
